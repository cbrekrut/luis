...
input_file = 'oz87 01.00.000.xlsx'
...
def extract_filtered_labor_data(input_file):
    ...
    filtered_data.to_excel('1.xlsx',index=False)
    print('-'*6,type(filtered_data),'-'*6)
...
print('-'*6,type(df_final_filtered_table),'-'*6)
